  ...
  return (
    <footer id={style.parentContainer}>
      ...
      <section className={style.sectionTwo}>
        <h1 style={{ marginBottom: "15px" }}>Product Collection</h1>
      ...
      <section className={style.sectionThree}>
        <h1 style={{ marginBottom: "15px" }}>Our Policies</h1>
      ...
      <section className={style.sectionFour}>
        ...
        <h5>Call Us: 8319300047</h5>
        <h5>Email: agriconnect@gmail.com</h5>
      </section>

      <section className={style.sectionFive}>
        <h1 style={{ marginBottom: "45px" }}>Follow Us</h1>
        <Stack>
          <HStack width={"50%"}>
            <Image
              boxSize="35px"
