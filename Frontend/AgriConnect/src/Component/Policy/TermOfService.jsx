  ...
  return (
    <div className="terms-of-service">
      ...
      <p>
        ...
        conditions. Do not continue to use AgriConnect if you do not agree to
      ...
      <p>
        Cookies We employ the use of cookies. By accessing AgriConnect, you
        agreed to use cookies in agreement with the AgriConnect's Privacy
        Policy.
      </p>
      <p>
      ...
      <p>
        License Unless otherwise stated, AgriConnect and/or its licensors own
        the intellectual property rights for all material on AgriConnect. All
        intellectual property rights are reserved. You may access this from
        AgriConnect for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from AgriConnect</li>
        <li>Sell, rent or sub-license material from AgriConnect</li>
        <li>Reproduce, duplicate or copy material from AgriConnect</li>
        <li>Redistribute content from AgriConnect</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        AgriConnect does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of AgriConnect,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, AgriConnect shall not be
      ...
      <p>
        AgriConnect reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant AgriConnect a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
      </p>
      <h2>No warranties</h2>
      <p>
        This Website is provided "as is," with all faults, and AgriConnect
      ...
      <p>
        In no event shall AgriConnect, nor any of its officers, directors and
        ...
        under contract. AgriConnect, including its officers, directors and
      ...
      <p>
        You hereby indemnify to the fullest extent AgriConnect from and against
      ...
      <p>
        AgriConnect is permitted to revise these Terms at any time as it sees
        fit, and by using this Website you are expected to review these Terms on
        a regular basis.
      </p>
      <h2>Assignment</h2>
      <p>
        The AgriConnect is allowed to assign, transfer, and subcontract its
      ...
      <p>
        These Terms constitute the entire agreement between AgriConnect and you
      ...
      <p>
        ...
        such changes constitutes your acceptance of the new terms and policies.
        If you have any questions or concerns about these terms and policies,
        please contact us at agriconnect20@gmail.com.
      </p>
    </div>
  );
};
